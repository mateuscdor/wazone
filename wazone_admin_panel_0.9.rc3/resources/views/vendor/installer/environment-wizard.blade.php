...
$app_url = str_replace('/public','',url('/'));

if (stripos($app_url, '//localhost') > -1 || stripos($app_url, '//192.') > -1) {
    $node_url = 'http://localhost' . ':' . env('APP_PORT');
} else {
    $node_url = $app_url;
}
?>
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('app_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="app_name" id="app_name" value="Wazone" placeholder="{{ trans('installer_messages.environment.wizard.form.app_name_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('environment') ? ' has-error ' : '' }}" hidden>
                ...
                <div class="form-group {{ $errors->has('app_debug') ? ' has-error ' : '' }}" hidden>
                    <label for="app_debug">
                ...
                <div class="form-group {{ $errors->has('app_port') ? ' has-error ' : '' }}">
                    <label for="app_port">
                        {{ trans('installer_messages.environment.wizard.form.app_port_label') }}
                    </label>
                    <input type="number" name="app_port" id="app_port" value="{{ env('APP_PORT') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.db_port_placeholder') }}" />
                    @if ($errors->has('app_port'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                            {{ $errors->first('app_port') }}
                        </span>
                    @endif
                </div>
                ...
                <div class="form-group {{ $errors->has('app_url') ? ' has-error ' : '' }}">
                    ...
                    <input type="url" name="app_url" id="app_url" value="{{ $app_url }}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_url_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('node_url') ? ' has-error ' : '' }}">
                    <label for="node_url">
                        {{ trans('installer_messages.environment.wizard.form.node_url_label') }}
                    </label>
                    <input type="text" name="node_url" id="node_url" value="{{ $node_url }}" placeholder="{{ trans('installer_messages.environment.wizard.form.node_url_placeholder') }}" />
                    @if ($errors->has('node_url'))
                        <span class="error-block">
                            <i class="fa fa-fw fa-exclamation-triangle" aria-hidden="true"></i>
                            {{ $errors->first('node_url') }}
                        </span>
                    @endif
                </div>
                ...
                <div class="form-group {{ $errors->has('app_timezone') ? ' has-error ' : '' }}">
                    <label for="app_timezone">
                        ...
                        <a href="https://en.wikipedia.org/wiki/List_of_tz_database_time_zones?msclkid=49a1e75dac5011ecb2ff673d81958373" target="_blank"> (Check HERE!)</a>
                    </label>
                    <input type="text" name="app_timezone" id="app_timezone" value="Asia/Jakarta" placeholder="{{ trans('installer_messages.environment.wizard.form.app_timezone_placeholder') }}" />
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group {{ $errors->has('database_hostname') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_hostname" id="database_hostname" value="{{ env('DB_HOST') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.db_host_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_port') ? ' has-error ' : '' }}">
                    ...
                    <input type="number" name="database_port" id="database_port" value="{{ env('DB_PORT') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.db_port_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_name" id="database_name" value="{{ env('DB_DATABASE') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.db_name_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_username" id="database_username" value="{{ env('DB_USERNAME') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.db_username_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_password') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_password" id="database_password" value="{{ env('DB_PASSWORD') }}" placeholder="{{ trans('installer_messages.environment.wizard.form.db_password_placeholder') }}" />
                ...
                <div class="block">
                    ...
                    <div class="info">
                        <div class="form-group {{ $errors->has('mail_driver') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_driver" id="mail_driver" value="{{env('MAIL_MAILER')}}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_driver_placeholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('mail_host') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_host" id="mail_host" value="{{env('MAIL_HOST')}}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_host_placeholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('mail_port') ? ' has-error ' : '' }}">
                            ...
                            <input type="number" name="mail_port" id="mail_port" value="{{env('MAIL_PORT')}}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_port_placeholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('mail_username') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_username" id="mail_username" value="{{env('MAIL_USERNAME')}}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_username_placeholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('mail_password') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_password" id="mail_password" value="{{env('MAIL_PASSWORD')}}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_password_placeholder') }}" />
                        ...
                        <div class="form-group {{ $errors->has('mail_encryption') ? ' has-error ' : '' }}">
                            ...
                            <input type="text" name="mail_encryption" id="mail_encryption" value="{{env('MAIL_ENCRYPTION')}}" placeholder="{{ trans('installer_messages.environment.wizard.form.app_tabs.mail_encryption_placeholder') }}" />
