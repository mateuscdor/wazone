...
$(function () {
  ...
  if (pageBlockCustom.length) {
    pageBlockCustom.on('click', function () {
      $.blockUI({
        message:
          '<div class="d-flex justify-content-center align-items-center"><p class="me-50 mb-0">Processing Payment...</p> <div class="spinner-grow spinner-grow-sm text-success" role="status"></div> </div>',
        timeout: 1000,
        css: {
          backgroundColor: 'transparent',
          color: '#fff',
